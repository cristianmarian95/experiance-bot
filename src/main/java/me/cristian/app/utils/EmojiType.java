...
public class EmojiType {
    ...
    public final static String NAME = EmojiParser.parseToUnicode(":name_badge:");
    public final static String ID= EmojiParser.parseToUnicode(":id:");
    ...
    public final static String WINK = EmojiParser.parseToUnicode(":wink:");
    ...
    public final static String PLAYER = EmojiParser
    ...
    public final static String NEXT_TRACK = EmojiParser
    ...
    /* Fun */
    public final static String TADA = EmojiParser.parseToUnicode(":tada: ");
    ...
    /* Moderation */
    public final static String MODERATION = EmojiParser.parseToUnicode(":hammer:");
    public final static String ADMINISTRATION = EmojiParser.parseToUnicode(":no_entry_sign:");
    public final static String NSFW = EmojiParser.parseToUnicode(":underage:");
}
